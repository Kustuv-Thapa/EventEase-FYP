...
export default function UserProfile() {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    if (avatarChanged)        updates.avatar = avatarPreview; // "" = remove
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", padding: "32px 24px 56px" }}>
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
              ...
              {avatarPreview && (
                <button
                  ...
                  style={{
                    background: "none", border: "1px solid #fecdd3", borderRadius: 999,
                    padding: "3px 12px", fontSize: 12, fontWeight: 600,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: 15, fontWeight: 800, color: "#3730a3", margin: 0 }}>
              Account Information
            </h3>
          </div>
          ...
          <form onSubmit={handleProfileSubmit} style={{ padding: "24px 28px" }}>
            {profileSuccess && (
              <div style={{
                ...
                padding: "11px 14px", marginBottom: 20, fontSize: 14,
                color: "#15803d", fontWeight: 600, display: "flex", gap: 8,
              }}>
                ✅ {profileSuccess}
              </div>
            )}
        ...
        <div style={{
          ...
          <form onSubmit={handlePasswordSubmit} style={{ padding: "24px 28px" }}>
            ...
            <button
              type="submit"
              disabled={pwLoading}
              className={`btn btn-primary${pwLoading ? " btn-loading" : ""}`}
            >
